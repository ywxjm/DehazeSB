...
def train(opt):
    ...
    train_loss = {}
    ## 创建列表全部为X的字符串
    learn_prompt = Prompts([" ".join(["X"] * (opt.length_prompt))]).cuda()
    ...
    prompt_train_dataset_1 = dataloader_prompt_add.lowlight_loader_only_gazy(opt.lowlight_images_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', type=str,
                        default="train_only_hazy_prompt")
    ...
    parser.add_argument('--prompt_snapshots_folder', type=str,
                        default="/data/lanyunwei/my_experiment_results/CUNSB_RFIE/model/hazy_prompt_retrain_save_dir/")
