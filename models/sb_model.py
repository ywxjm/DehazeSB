...
class SBModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        """
        parser.add_argument('--mode', type=str, default="sb", choices='(FastCUT, fastcut, sb, sbunet)')
        ...
        parser.add_argument('--DSC_number',type=int,default=16,help='DSCNet basic conv channel')
        parser.add_argument('--DSC_n_blocks',type=int,default=4,help='number of middle resnet block')
    ...
    def compute_G_loss(self):  
        ...
        self.loss_G = self.loss_G_GAN + self.opt.lambda_SB*self.loss_SB + self.opt.lambda_NCE*loss_NCE_both  + self.loss_SSIM * self.opt.lambda_ssim
        return self.loss_G
