...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--haze2020_result_dir', type=str, default="sbunetdcp")
        parser.add_argument('--prompt_pretrain_dir', type=str, default="sbunetdcp")
        parser.add_argument('--validate_dir', default='/output/result_display/',
                            help='val_result_dir')
        parser.add_argument('--validate_model_dir', default='/output/val_model_result/',
                            help='val_result_dir')
        parser.add_argument('--project', default='placeholder',
                            help='name to wandb')
        ...
        parser.add_argument('--netD', type=str, default='basic_cond_nccl', choices=['basic', 'basic_cond_nccl', 'n_layers', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
